...
public class OrderController {
    ...
    //chatGpt
    @PostMapping()
    public ResponseEntity<?> createOrder(@RequestBody Order order, @PathVariable int shopId) {
        try {

            return new ResponseEntity<>(orderService.createOrder(order, shopId), HttpStatus.CREATED);
        } catch (Exception e) {
